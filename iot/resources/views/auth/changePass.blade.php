...
@section('content')
    <div class="col-sm-9 col-xs-12 content pt-3 pl-0">
        <h5 class="mb-0"><strong>Đổi mật khẩu</strong></h5>
        <span class="text-secondary"> Trang chủ <i class="fa fa-angle-right"></i> Đổi mật khẩu </span>
        <div class="row mt-3">
            <!--User profile content-->
                ...
                <div class="col-sm-12 col-md-8" style="flex:0 0 100%; max-width: 100%">
                        <div class="login-box-form" style="width: 100%; text-align: center; margin: auto">
                            <form method="post" action="{{route('postAdChangePass')}}" class="mt-2" style="width: 50%; display: inline-block">
                                @csrf
                                @error('mes')
