<div class="container-fluid">
    ...
    <div class="col-md-4 offset-md-4 col-sm-4 offset-sm-4">
        <div class="code text-theme mt-5">Welcome to our system!</div>
        <div class="title mb-4 text-center text-secondary text-uppercase">Hệ thống giám sát ao nuôi thủy sản là một hệ thống hoàn toàn mới. Chúc bạn sử dụng hệ thống của chúng tôi đạt kết quả tốt nhất!></div>
    ...
    {{--            <div class="mb-2">--}}
    {{--                &copy; 2019 <strong class="text-theme">A-Fusion</strong>. All rights reserved.--}}
    {{--            </div>--}}
    {{--            <div>--}}
